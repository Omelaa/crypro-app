...
import {
    CheckOutlined, DollarCircleOutlined,
    ExclamationCircleOutlined,
    FundOutlined,
    MoneyCollectOutlined, NumberOutlined,
    StopOutlined, ThunderboltOutlined, TrophyOutlined
...
const CryptoDetails = () => {
    ...
    if (!cryptoDetails?.data) return <div>Loading...</div>
